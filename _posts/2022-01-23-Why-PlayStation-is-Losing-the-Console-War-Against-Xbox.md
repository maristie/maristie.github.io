...
Xbox finally removed the beta tag from their xCloud streaming service along with a price hike to Xbox Game Pass Ultimate. However, the only substantial improvement is in resolution (up to 1440p) and correspondingly bitrates. On the contrary, Nvidia GeForce Now has been rolling out a lot of features in the past few months: 5k 120 fps, 10-bit YUV 4:4:4 color, RTX 5080-class performance with DLSS 4, Multi Frame Generation and transformer model. xCloud is not even close.

Essentially, xCloud has been doing nothing to catch up with their biggest competitor in cloud gaming in the past three years, and Nvidia has been leaving everyone else behind in the race. It's a shame that the management has never pushed for any significant improvements, only to symbolically remove the "beta" after all the years in vain. GeForce Now is trying to overcome its disadvantage by expanding its game library via Install-to-Play for whichever game opted into cloud gaming on Steam. We have not seen any similar effort from xCloud side to provide a basic 4k 60fps experience at all.

The incompetence of xCloud is starting to destroy the value of Game Pass. Adding more games to Game Pass, including the most popular ones, might be a good move to attract subscribers for a while, but it was not enough to distinguish itself from its competitors. The unique advantage of Game Pass still lies in the combination of its game library and cloud gaming, therefore xCloud should be ready to match GeForce Now Ultimate and make it available to more regions with a reasonable price. Most Ultimate subscribers will not compromise on the graphics; and $30 does not justify its current streaming quality, which is more expensive than almost every other subscription services in all kinds of markets.

If Xbox management is still taking Game Pass and cloud gaming seriously, they need to realize that their true competitor is GeForce Now. PlayStation subscription only works on their consoles, and other subscriptions offered by Ubisoft, EA or Rockstar are not really competing with Game Pass. Game Pass now owns the most popular Call of Duty series, and xCloud is the way to make games available to as many people as possible. The ideal is great, but without action it's just a castle in the air.
